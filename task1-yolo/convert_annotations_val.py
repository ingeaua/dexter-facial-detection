...
input_base_dir = "../../validare"
output_images_dir = "images/val"
...
annotation_file = os.path.join(input_base_dir, 'validare_annotations.txt')
image_folder = os.path.join(input_base_dir, 'validare')
...
for image_name, boxes in image_annotations.items():
    ...
    new_image_name = f"{image_counter:03d}.jpg"
    ...
    with open(output_label_path, "w") as olf:
        for xmin, ymin, xmax, ymax, label in boxes:
            ...
            olf.write(f"0 {x_center:.6f} {y_center:.6f} {width:.6f} {height:.6f}\n")
